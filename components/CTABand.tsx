        ...
        <div className="max-w-6xl mx-auto px-4 py-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Magnetic>
              ...
              >
                Get My Free Quote <span className="arrow-nudge" aria-hidden="true">→</span>
              </Link>
            </Magnetic>
            <Magnetic>
              <a
                href={`tel:${PHONE_RAW}`}
                className="btn-press inline-flex items-center justify-center px-8 py-4 rounded-xl font-bold text-base border-2 transition-all hover:scale-105 hover:bg-navy/5"
